...
| --- | --- | ---: |
| `../baseline_fineweb_only/train_baseline_fineweb_only.py` | FineWeb-Edu only | 39.67 |
| `../baseline_openwebtext_only/train_baseline_openwebtext_only.py` | OpenWebText only | 65.21 |
| `train_baseline_mix_50_20_15_15.py` | FineWeb/Wikipedia/science/books, 50/20/15/15 | **38.8281** |
