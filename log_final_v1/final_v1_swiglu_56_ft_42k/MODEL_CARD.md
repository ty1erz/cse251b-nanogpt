# Model card — final_v1_swiglu_56_ft_42k

**Generated:** 2026-05-25T10:58:53
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.006, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=0.00024, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=42000 (≈ 22.02 B tokens)
- ckpt_every=500, eval_every=250
- grad_clip=1.0

## Results
- Final step: 41999
- **Final val loss (mix val shard):** 3.0151
- **val.bin perplexity:** 20.2278
- val.bin avg loss (nats): 3.0071
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-25T06:51:20
- Ended:   2026-05-25T10:58:53
- Wall-clock: 4.13 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_42k --max_steps 42000`
