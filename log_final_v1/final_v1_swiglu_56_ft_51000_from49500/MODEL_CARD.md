# Model card — final_v1_swiglu_56_ft_51000_from49500

**Generated:** 2026-05-26T09:27:19
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.0004, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=2.5e-05, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=51000 (≈ 26.74 B tokens)
- ckpt_every=250, eval_every=250
- grad_clip=1.0

## Results
- Final step: 50999
- **Final val loss (mix val shard):** 2.9587
- **val.bin perplexity:** 19.0900
- val.bin avg loss (nats): 2.9492
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-26T07:40:58
- Ended:   2026-05-26T09:27:19
- Wall-clock: 1.77 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_51000_from49500 --max_steps 51000`
