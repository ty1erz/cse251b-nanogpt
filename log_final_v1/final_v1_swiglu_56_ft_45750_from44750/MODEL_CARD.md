# Model card — final_v1_swiglu_56_ft_45750_from44750

**Generated:** 2026-05-25T19:32:00
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.0015, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=8e-05, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=45750 (≈ 23.99 B tokens)
- ckpt_every=250, eval_every=250
- grad_clip=1.0

## Results
- Final step: 45749
- **Final val loss (mix val shard):** 2.9730
- **val.bin perplexity:** 19.4139
- val.bin avg loss (nats): 2.9660
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-25T18:21:13
- Ended:   2026-05-25T19:32:00
- Wall-clock: 1.18 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_45750_from44750 --max_steps 45750`
