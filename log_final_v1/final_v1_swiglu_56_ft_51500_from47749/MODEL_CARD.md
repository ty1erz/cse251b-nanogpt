# Model card — final_v1_swiglu_56_ft_51500_from47749

**Generated:** 2026-05-26T05:34:46
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.0007, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=4e-05, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=51500 (≈ 27.00 B tokens)
- ckpt_every=750, eval_every=750
- grad_clip=1.0

## Results
- Final step: 51499
- **Final val loss (mix val shard):** 2.9610
- **val.bin perplexity:** 19.1499
- val.bin avg loss (nats): 2.9523
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-26T01:09:43
- Ended:   2026-05-26T05:34:46
- Wall-clock: 4.42 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_51500_from47749 --max_steps 51500`

Checkpoints in this directory: every 750 steps + final.
