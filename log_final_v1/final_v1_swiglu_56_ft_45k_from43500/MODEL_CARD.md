# Model card — final_v1_swiglu_56_ft_45k_from43500

**Generated:** 2026-05-25T18:09:08
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.003, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=0.000135, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=45000 (≈ 23.59 B tokens)
- ckpt_every=250, eval_every=250
- grad_clip=1.0

## Results
- Final step: 44999
- **Final val loss (mix val shard):** 2.9855
- **val.bin perplexity:** 19.6979
- val.bin avg loss (nats): 2.9805
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-25T16:22:53
- Ended:   2026-05-25T18:09:08
- Wall-clock: 1.77 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_45k_from43500 --max_steps 45000`
