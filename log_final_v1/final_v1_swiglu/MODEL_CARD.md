...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=1e-05, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=1e-05, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 0 → cosine to 0.5× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=46001 (≈ 24.12 B tokens)
- ckpt_every=250, eval_every=250
- grad_clip=1.0

## Results
- Final step: 46000
- **Final val loss (mix val shard):** 2.9831
- **val.bin perplexity:** 19.4353
- val.bin avg loss (nats): 2.9671
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-19T23:57:58
- Ended:   2026-05-20T00:17:10
- Wall-clock: 0.32 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu --max_steps 46001`
