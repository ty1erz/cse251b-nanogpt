# Model card — final_v1_swiglu_56_ft_44k

**Generated:** 2026-05-25T16:16:38
...
- **Muon** for 64,430,080 2-D hidden parameters
  - lr=0.004, momentum=0.95, ns_steps=5, nesterov=True, wd=0.1
- **AdamW** for 32,213,504 embedding + 1-D parameters
  - lr=0.00018, betas=(0.9, 0.95), wd_embed=0, wd_norm=0
- Both schedulers: warmup 200 → cosine to 0.1× peak

## Hyperparameters
- micro_batch=16, seq_len=1024, total_batch_size=524288
- max_steps=44000 (≈ 23.07 B tokens)
- ckpt_every=500, eval_every=250
- grad_clip=1.0

## Results
- Final step: 43999
- **Final val loss (mix val shard):** 3.0009
- **val.bin perplexity:** 19.9547
- val.bin avg loss (nats): 2.9935
- tokens evaluated: 5,169,152

## Reproducibility
- Started: 2026-05-25T13:52:19
- Ended:   2026-05-25T16:16:38
- Wall-clock: 2.41 h
- Seed: 1337
- Run script: `train_final_v1.py --run_name final_v1_swiglu_56_ft_44k --max_steps 44000`

Checkpoints in this directory: every 500 steps + final.
