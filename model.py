"""GPT architecture shared by training and exported evaluation bundles.

Default architecture:
  - 16 decoder blocks, width 640
  - 10 query heads and 5 key/value heads (grouped-query attention)
  - rotary position embeddings and RMSNorm
  - SwiGLU MLP with intermediate width 1536
