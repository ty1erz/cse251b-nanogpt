...
# create model
resume_checkpoint = "/data/fengfei/cse251b-nanogpt/build-nanogpt/log/v4/submission_20260426_alvin_v4_20000/checkpoint.pt"
resume_step = 20000
...
remaining_total_tokens = cosmopedia_total_tokens
dataset_ranges_v5 = [
    {
        "name": "cosmopedia_only",
...
if master_process:
    ...
    print(f"remaining fineweb tokens (unused in v5): {remaining_fineweb_tokens:,}")
    print(f"cosmopedia tokens available for v5: {cosmopedia_total_tokens:,}")
    print(f"remaining total tokens for v5: {remaining_total_tokens:,}")
    print(f"max_steps for one pass over full train.bin: {max_steps:,}")
    print(f"remaining v5 steps: {remaining_steps:,}")
    print("v5 dataset ranges:")
