...
# v13 keeps the v12 architecture but uses zzw's data mix and optimizer recipe.
V13_SOURCE_SPECS = [
...
def parse_args():
    ...
    parser.add_argument("--resume", type=str, default=None, help="Path to a v13 train_ckpt_*.pt checkpoint")
...
def main():
    ...
    model.to(device)
    model_config.exp_name = "alvin_v13_zzw_mix_muon"
    raw_model = model
